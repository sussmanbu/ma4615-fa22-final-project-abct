...
ggplot(incomescore6, aes(x = income.bracket, y = average.total.score.of.bracket, color = state.code)) + geom_col() + labs(title="Average SAT Score By State", x = "State", y = "SAT Score", color="State.Code")
```
