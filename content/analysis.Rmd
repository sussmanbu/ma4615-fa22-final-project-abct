...
ggplot(schooldata, aes(x = state.code, y = total.score, color= state.code)) + geom_point(position = "jitter") + coord_polar("x") + labs(title = "SAT Score by State", x = "State", y = "SAT Score", color ="State")
