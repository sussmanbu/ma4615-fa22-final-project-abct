...
schooldatacleaned_math <- schooldatacleaned %>% 
  ...
  filter(state.code %in% threestates) %>% 
...
schooldatacleaned <- schooldatacleaned_math %>%
  left_join(schooldatacleaned_verbal, by = c("state.code" = "state.code"))

#schooldatacleaned <- schooldatacleaned %>% select("state.code", "income.bracket.math", "total.math", "total.verbal") 
schooldatacleaned
```
...
schooldatacleaned <- schooldatacleaned %>% 
  ...
  select("state.code", "income.bracket.math", "average.total.score.of.bracket") %>% 
  group_by(income.bracket.math) 
schooldatacleaned
