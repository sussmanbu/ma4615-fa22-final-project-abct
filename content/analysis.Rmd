...
schooldatacleaned <- schooldatacleaned_math %>%
  left_join(schooldatacleaned_verbal, by = c("income.bracket" = "income.bracket",
...
ggplot(data = schooldatacleaned, 
       mapping = aes(x = income.bracket.math, 
                     y = average.total.score.of.bracket, 
                     fill = income.bracket.math)) + 
  geom_col(aes(color = income.bracket.math)) + 
...
ggplot() + geom_polygon(data = MergedStates, aes(x = long, y = lat, group = group, 
  ...
  scale_fill_continuous(low = "springgreen", high = "springgreen4", name = "Avg. SAT Score") + 
