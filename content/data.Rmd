...
schooldatacleaned_pivoted <- schooldatacleaned_math %>% 
...
schooldatacleaned_pivoted
```
We then loaded this into a new csv file as well, titled "schooldatacleaned_pivot.csv"
